...
(iv) the spectral MDS anchor never wins on any of the 8 BEIR sets
we ran anchor ablations on -- Top-3 wins 5/8, Random wins 3/8,
and Spectral finishes \emph{last} on 3/8 sets (TREC-COVID,
Touch\'e-2020, Robust04), contradicting the paper's reported
BEIR-aggregate ordering; (v) the contrastive-anchor mechanism
...
and Qwen-2.5-72B-Instruct-AWQ (4-bit AWQ-quantized, on a single
...
(Section~\ref{sec:undocumented}). The method's central claim --
that an anchor-based contrastive prompt, aggregated with RG-YN,
yields a strong pointwise re-ranker -- holds.
...
\begin{enumerate}[leftmargin=1.5em,nosep]
    ...
    \item The \textbf{spectral MDS anchor never wins} on any of the
          ...
          Spectral (0.4471) $>$ Top (0.4346) $>$ Random (0.4253). Our Spectral number matches
