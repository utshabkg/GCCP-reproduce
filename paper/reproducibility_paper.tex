...
find \textbf{the headline ``PAGC always helps'' framing does not
...
reaching PAGC NDCG@10 $=0.7465$ on DL19, exceeding both our
reproduced Flan-UL2 ($0.7095$) and the paper's reported Flan-UL2
(both the 2-component RG-YN+GCCP variant at $0.7206$ and the
3-component PAGC-QSG variant at $0.7200$); a compute-capped
50-query check on BEIR-SciFact reproduces the strict
PAGC$>$GCCP$>$RG-YN ordering under this 72B backbone, and on
BEIR-DBPedia-Entity it \emph{reproduces our negative
PAGC$<$GCCP-alone finding} -- showing the negative DBPedia
result is not a Flan-T5 quirk but survives a complete change
of backbone family, scale, and precision.
\end{abstract}
...
\begin{itemize}[leftmargin=1.5em,nosep]
    \item \textbf{Random-5 averaging} ($\{0,42,929,12345,2023\}$,
          ...
          $0.4364$ -- closes $\sim 30\%$ of the Random gap
...
Random-5 averaging            & 0.4364 & 0.5673 & 0.4115 & 0.2805 & 0.2825 & $\Delta{+}0.011$ (closes $\sim 30\%$) \\
\midrule
